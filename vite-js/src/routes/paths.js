...
export const paths = {
  ...
  dashboard: {
    ...
    powerTool: {
      root: `${ROOTS.DASHBOARD}/power-tool`,
      processBoard: `${ROOTS.DASHBOARD}/power-tool/process-board`,
      productCategories: `${ROOTS.DASHBOARD}/power-tool/product-categories`,
      productGroup: `${ROOTS.DASHBOARD}/power-tool/product-group`,
      bookedExchangeRate: `${ROOTS.DASHBOARD}/power-tool/booked-exchange-rate`,
      shippedExchangeRate: `${ROOTS.DASHBOARD}/power-tool/shipped-exchange-rate`,
    ...
    reports: {
      ...
      inquiry: `${ROOTS.DASHBOARD}/reports/inquiry`,
